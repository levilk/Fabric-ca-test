...
export FABRIC_CA_CLIENT_ID_AFFILIATION=org0
...
function initOrgVars {
   ...
   #Admin identity for the org if the orderer and Peer is on the same org
   PEER_ADMIN_NAME=peer-admin-${ORG}
   PEER_ADMIN_PASS=${PEER_ADMIN_PASS}pw
